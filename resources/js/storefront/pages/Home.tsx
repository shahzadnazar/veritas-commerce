...
import { CardGridSkeleton, EmptyState } from '../../design-system/patterns/States';
...
export default function Home() {
    const { stats, platform } = usePage<HomeProps>().props;
    ...
    return (
        <StorefrontLayout>
            ...
            <h2 className="mb-6 text-[32px]">Featured this week</h2>
